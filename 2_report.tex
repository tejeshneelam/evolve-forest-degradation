...
\begin{itemize}[noitemsep, topsep=1pt]
    ...
    \item \textbf{Roadmap for Review 2 (Target: 85--90\% Completion):} Expand empirical validation against historical Wayanad landslide coordinates, benchmark seasonal fire fuel flammability models, and deploy production Docker container on Google Cloud Run.
\end{itemize}
