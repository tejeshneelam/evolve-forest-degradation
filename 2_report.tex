...
\begin{minipage}{\textwidth}
    ...
    \vspace{0.1cm}
    \textbf{23CSE399 -- Project Phase 2 (Panel Review 1)} \quad | \quad \textbf{Team Number: [XX]} \quad | \quad September 9, 2026
\end{minipage}
...
\begin{figure}[H]
    ...
    \IfFileExists{slides_assets/system_architecture.png}{
        \includegraphics[width=0.95\textwidth, height=4.8cm, keepaspectratio]{slides_assets/system_architecture.png}
    }{
